...
{
    /// <summary>
    /// 加速度振动信号历史数据表（加速度振动信号ID和采集时间创建索引）
    /// </summary>
    [Table("T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ACC")]
    public class VibratingSingalCharHisAcc : EntityBase
    {
        #region Model
        public VibratingSingalCharHisAcc()
        {
            Rotate = "-";
            TransformCofe = 0;
