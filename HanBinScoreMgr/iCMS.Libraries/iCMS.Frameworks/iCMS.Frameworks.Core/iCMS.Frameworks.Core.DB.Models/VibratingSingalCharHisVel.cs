...
{
    /// <summary>
    /// 速度振动信号历史数据表（速度振动信号ID和采集时间创建索引）
    /// </summary>
    [Table("T_DATA_VIBRATING_SIGNAL_CHAR_HIS_VEL")]
    public class VibratingSingalCharHisVel : EntityBase
    {
        #region Model
        public VibratingSingalCharHisVel()
        {
            Rotate = "-";
            TransformCofe = 0;
        ...
        /// 低频能量值警告值
        /// </summary>
        public float? LPEWarnValue { get; set; }

        /// <summary>
        /// 低频能量值告警值
        /// </summary>
        public float? LPEAlmValue { get; set; }

        /// <summary>
        /// 中频能量值警告值
        /// </summary>
        public float? MPEWarnValue { get; set; }

        /// <summary>
        /// 中频能量值告警值
        /// </summary>
        public float? MPEAlmValue { get; set; }

        /// <summary>
        /// 高频能量值警告值
        /// </summary>
        public float? HPEWarnValue { get; set; }

        /// <summary>
        /// 高频能量值告警值
        /// </summary>
        public float? HPEAlmValue { get; set; }
