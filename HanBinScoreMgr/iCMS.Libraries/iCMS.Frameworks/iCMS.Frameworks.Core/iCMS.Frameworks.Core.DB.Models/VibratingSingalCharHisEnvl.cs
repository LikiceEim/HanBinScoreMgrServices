...
{
    /// <summary>
    /// 包络振动信号历史数据表（包络振动信号ID和采集时间创建索引）
    /// </summary>
    [Table("T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ENVL")]
    public class VibratingSingalCharHisEnvl : EntityBase
    {
        #region Model
        public VibratingSingalCharHisEnvl()
        {
            Rotate = "-";
            TransformCofe = 0;
        ...
        /// 地毯值警告值
        /// </summary>
        public float? CarpetWarnValue { get; set; }

        /// <summary>
        /// 地毯值告警值
        /// </summary>
        public float? CarpetAlmValue { get; set; }

        /// <summary>
        /// 均值警告值
        /// </summary>
        public float? MEANWarnValue { get; set; }

        /// <summary>
        /// 均值告警值
        /// </summary>
        public float? MEANAlmValue { get; set; }
