...
namespace iCMS.Common.Component.Data.Base
{
    ...
    public class OperationResult
    {
        ...
        public OperationResult(EnumOperationResultType resultType)
        {
        ...
        public OperationResult(EnumOperationResultType resultType, string message)
            : this(resultType)
        {
            Message = message;
        }
        ...
        public OperationResult(EnumOperationResultType resultType, string message, object appendData)
        ...
        public OperationResult(EnumOperationResultType resultType, string message, string logMessage)
            : this(resultType, message)
        {
        ...
        /// <param name="logMessage">业务日志记录消息</param>
        /// <param name="appendData">业务返回数据</param>
        public OperationResult(EnumOperationResultType resultType, string message, string logMessage, object appendData)
        ...
        ///     获取或设置 操作结果类型
        /// </summary>
        public EnumOperationResultType ResultType { get; set; }
