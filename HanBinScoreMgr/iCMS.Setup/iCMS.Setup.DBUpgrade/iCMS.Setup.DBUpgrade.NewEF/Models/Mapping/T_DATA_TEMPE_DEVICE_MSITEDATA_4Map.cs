...
{
    public class T_DATA_TEMPE_DEVICE_MSITEDATA_4Map : EntityTypeConfiguration<T_DATA_TEMPE_DEVICE_MSITEDATA_4>
    {
        public T_DATA_TEMPE_DEVICE_MSITEDATA_4Map()
        {
            // Primary Key
            ...
            this.ToTable("T_DATA_TEMPE_DEVICE_MSITEDATA_4");
