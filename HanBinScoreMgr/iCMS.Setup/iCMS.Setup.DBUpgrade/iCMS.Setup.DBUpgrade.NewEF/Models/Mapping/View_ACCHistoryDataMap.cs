...
{
    public class View_ACCHistoryDataMap : EntityTypeConfiguration<View_ACCHistoryData>
    {
        public View_ACCHistoryDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.DevID, t.ACCPEAKValueStat, t.CollectitTime, t.DataType });
            ...
            this.Property(t => t.ACCPEAKValueStat)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("View_ACCHistoryData");
