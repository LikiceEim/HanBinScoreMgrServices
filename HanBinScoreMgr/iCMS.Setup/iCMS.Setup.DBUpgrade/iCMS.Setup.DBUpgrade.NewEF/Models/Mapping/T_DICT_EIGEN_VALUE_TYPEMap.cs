...
{
    public class T_DICT_EIGEN_VALUE_TYPEMap : EntityTypeConfiguration<T_DICT_EIGEN_VALUE_TYPE>
    {
        public T_DICT_EIGEN_VALUE_TYPEMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("T_DICT_EIGEN_VALUE_TYPE");
