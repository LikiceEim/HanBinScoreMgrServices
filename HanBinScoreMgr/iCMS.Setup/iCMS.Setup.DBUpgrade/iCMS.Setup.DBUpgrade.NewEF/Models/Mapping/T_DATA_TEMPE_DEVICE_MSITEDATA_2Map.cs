...
{
    public class T_DATA_TEMPE_DEVICE_MSITEDATA_2Map : EntityTypeConfiguration<T_DATA_TEMPE_DEVICE_MSITEDATA_2>
    {
        public T_DATA_TEMPE_DEVICE_MSITEDATA_2Map()
        {
            // Primary Key
            ...
            this.ToTable("T_DATA_TEMPE_DEVICE_MSITEDATA_2");
