...
{
    public class View_DevHistoryDataMap : EntityTypeConfiguration<View_DevHistoryData>
    {
        public View_DevHistoryDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.CollectitTime, t.DataType });
            ...
            this.ToTable("View_DevHistoryData");
