...
{
    public class T_DICT_MEASURE_SITE_TYPEMap : EntityTypeConfiguration<T_DICT_MEASURE_SITE_TYPE>
    {
        public T_DICT_MEASURE_SITE_TYPEMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("T_DICT_MEASURE_SITE_TYPE");
