...
{
    public class View_VELHistoryDataMap : EntityTypeConfiguration<View_VELHistoryData>
    {
        public View_VELHistoryDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.DevID, t.SpeedVirtualValueStat, t.CollectitTime, t.DataType });
            ...
            this.Property(t => t.SpeedVirtualValueStat)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("View_VELHistoryData");
