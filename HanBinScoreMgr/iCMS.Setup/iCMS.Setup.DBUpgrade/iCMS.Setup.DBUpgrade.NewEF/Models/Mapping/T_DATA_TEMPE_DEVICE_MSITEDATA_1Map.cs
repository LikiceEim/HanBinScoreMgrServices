...
{
    public class T_DATA_TEMPE_DEVICE_MSITEDATA_1Map : EntityTypeConfiguration<T_DATA_TEMPE_DEVICE_MSITEDATA_1>
    {
        public T_DATA_TEMPE_DEVICE_MSITEDATA_1Map()
        {
            // Primary Key
            ...
            this.ToTable("T_DATA_TEMPE_DEVICE_MSITEDATA_1");
