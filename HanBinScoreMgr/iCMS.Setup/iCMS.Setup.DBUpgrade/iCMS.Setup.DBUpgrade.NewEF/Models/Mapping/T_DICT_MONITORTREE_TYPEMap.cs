...
{
    public class T_DICT_MONITORTREE_TYPEMap : EntityTypeConfiguration<T_DICT_MONITORTREE_TYPE>
    {
        public T_DICT_MONITORTREE_TYPEMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("T_DICT_MONITORTREE_TYPE");
