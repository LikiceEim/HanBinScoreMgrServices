...
{
    public class View_DeviceTempHistortyDataMap : EntityTypeConfiguration<View_DeviceTempHistortyData>
    {
        public View_DeviceTempHistortyDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.TempValue, t.TempStat, t.CollectitTime, t.DataType });
            ...
            this.ToTable("View_DeviceTempHistortyData");
