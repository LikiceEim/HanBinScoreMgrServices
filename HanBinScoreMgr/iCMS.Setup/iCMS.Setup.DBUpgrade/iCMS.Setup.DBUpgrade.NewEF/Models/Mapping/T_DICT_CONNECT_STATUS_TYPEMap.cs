...
{
    public class T_DICT_CONNECT_STATUS_TYPEMap : EntityTypeConfiguration<T_DICT_CONNECT_STATUS_TYPE>
    {
        public T_DICT_CONNECT_STATUS_TYPEMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("T_DICT_CONNECT_STATUS_TYPE");
