...
{
    public class View_DISPHistoryDataMap : EntityTypeConfiguration<View_DISPHistoryData>
    {
        public View_DISPHistoryDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.DevID, t.DisplacementDPEAKValueStat, t.CollectitTime, t.DataType });
            ...
            this.Property(t => t.DisplacementDPEAKValueStat)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("View_DISPHistoryData");
