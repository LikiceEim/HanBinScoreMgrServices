...
{
    public class T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ACCMap : EntityTypeConfiguration<T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ACC>
    {
        public T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ACCMap()
        {
            // Primary Key
            ...
            this.ToTable("T_DATA_VIBRATING_SIGNAL_CHAR_HIS_ACC");
