...
{
    public class View_ENVLHistoryDataMap : EntityTypeConfiguration<View_ENVLHistoryData>
    {
        public View_ENVLHistoryDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MSiteID, t.DevID, t.EnvelopPEAKValueStat, t.CollectitTime, t.DataType });
            ...
            this.Property(t => t.EnvelopPEAKValueStat)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("View_ENVLHistoryData");
