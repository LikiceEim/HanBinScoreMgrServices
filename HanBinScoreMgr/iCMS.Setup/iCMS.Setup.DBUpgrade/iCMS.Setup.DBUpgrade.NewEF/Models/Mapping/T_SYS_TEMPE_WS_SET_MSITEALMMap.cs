...
{
    public class T_SYS_TEMPE_WS_SET_MSITEALMMap : EntityTypeConfiguration<T_SYS_TEMPE_WS_SET_MSITEALM>
    {
        public T_SYS_TEMPE_WS_SET_MSITEALMMap()
        {
            // Primary Key
            ...
            this.ToTable("T_SYS_TEMPE_WS_SET_MSITEALM");
