  ...
  <div>
    ...
    <div class="list-center" style="height:auto;">
      <div  class="list-half" style="height:auto;">
        <div style="display:inline-block;margin-left:20px;color:#000;font-size:15px;width:100%;">
          <span>待办事项</span>
          <span class="list-center-more" style="cursor:pointer;" @click="handleClickToDoList(1)">更多>></span>
        </div>
        <div class="list-content">
          <div class="list-content-div" v-show="isToDoListShow" :style="{width:isRole}">
            <span style="font-size:14px;font-weight:bold;display:inline-block;margin-left:10px;width:100%;">待我审批</span>
            <template v-for="(item, index) in ToDoList">
              <span :key="index" @click="handleClickToDoList(1)" style="width:100%;display:inline-block;padding-left:10px;display:flex;align-items: center;cursor:pointer;">
          ...
          <div class="list-content-div" v-show="isScoreChangeShow" :style="{width:isRole}">
            <span style="font-size:14px;font-weight:bold;display:inline-block;margin-left:10px;width:100%;">上级反馈</span>
            <template v-for="(item, index) in SuperiorFeedbackList">
              <span :key="index" @click="handleClickToDoList(2)" style="width:100%;display:inline-block;padding-left:10px;display:flex;align-items: center;cursor:pointer;">
                <span style="display:inline-block;width:8px;height:8px;border-radius:4px;background-color:#00c4f0;"></span>
                <span class="item-content-applytitle" :title="item.FeedBackTitle">{{item.FeedBackTitle}}</span>
        ...
        <div class="list-content" style="width:100%;background-color:#fff;flex-direction:column;">
            <template v-for="(item, index) in ScoreChangeHistory">
              <span :key="index" style="display:inline-block;width:100%;">
                <span @click="handleClickToDoList(3)" style="width:100%;display:inline-block;padding-left:10px;display:flex;align-items: center;cursor:pointer;">
    ...
    <div class="list-footer">
      <div class="list-footer-title">
        <div style="display:inline-block;margin-left:20px;color:#000;font-size:15px;width:100%;">
          <span>积分公示</span>
          <span class="list-center-more" style="cursor:pointer;" @click="handleClickToDoList(4)">更多>></span>
        </div>
      </div>
      <div>
...
<script>
    import { queryAllPageList, queryRedBoardData, queryBlackBoardData, queryToDoList, querySuperiorFeedbackList, queryScoreChangeHistory, queryScorePublicShow } from '@/api/homePages'
