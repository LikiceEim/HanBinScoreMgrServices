<template>
  <div>
          ...
          <Modal  width="570"
            ...
            <div style="text-align:center">
              <Form ref="formInline">
                ...
                <div class="ps">
                  <span>角色</span>
                  <RadioGroup calss="iv-input" v-model="addsystem" v-for="(item,index) in RoleList" :key="index">
    ...
    <Modal v-model="isForbidDialog" width="360">
        ...
        <div slot="footer">
            <i-button type="info" size="large" long :loading="modal_loading_forbid" @click="doForbidUser">确认</i-button>
        </div>
    </Modal>
    ...
    <div class="unltlistfyq">
      <Page :total="total" :current="current" :page-size="pageSize" @on-change="handleChangePage" show-elevator />
    </div>
...
<script>
  import { addUserList, queryUsersList, queryUnitName ,queryRoleList, editUserInfo, forbiddenUser, deleteUserInfo, resetPWD} from '@/api/usersManage'
          ...
          return{
            ...
            columns7: [
              ...
              },
              {
                ...
                render: (h,params)=>{
                  return h('span',
                    this.formatUseState(params.row.states)
                  )
                }
              },
              {
                ...
                render: (h, params) => {
                  return h('div', [
                    ...
                    h('Tooltip',{
                      ...
                      h('Icon', {
                      props: {
                        type: (params.row.states==true)?'md-close':'md-checkmark',// 禁用,启用
                      },
                      style: {
                        marginRight: '5px',
                        color:"#1296db",
          ...
          queryUsersList(_data).then(res => {
            ...
            if(res.IsSuccessful == true) {
              ...
              for(let i = 0; i < res.Result.UserInfoList.length; i++){
                ...
                tempObj.LastUpdateUserID = res.Result.UserInfoList[i].LastUpdateUserID;// 最后一次更新人
