    ...
    <div class="centers">
      ...
      <div class="personalList">
        ...
        <div class="createZb">
          ...
          <Tabs class="createZbs" :animated="false" v-if="false">
        ...
        <div class="personalName">
          ...
          <div style="text-align:left ">
            ...
            <p>单位简称，最长不超过10个字</p>-->
            <Select class="input" v-model="UnitClassification" style="width:300px;">
        ...
        if (Cookies.get("RoleID") == 4) {
          ...
          for (let i = 0; i < row.length; i++) {
            for (let j = 0; j < row[i].OrganTypeList.length; j++) {
              if (
                Cookies.get("OrganTypeID") ==
                row[i].OrganTypeList[j].OrganTypeID
              ) {
      ...
      queryUnitData(_data).then(res => {
        ...
        if (res.IsSuccessful == true) {
          ...
          for (let i = 0; i < res.Result.OrganInfoList.length; i++) {
            ...
            if (Cookies.get("RoleID") == 4) {
              if (
                Cookies.get("OrganID") == res.Result.OrganInfoList[i].OrganID
              ) {
                tempObj.disabled = false;
              } else {
                tempObj.disabled = true;
