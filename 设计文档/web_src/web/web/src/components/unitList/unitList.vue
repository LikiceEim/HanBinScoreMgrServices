    ...
    <div class="unltlistBot">
      ...
      <div class="unitLIstFl">
        <div>
          ...
          <Input class="unltlistInput" style="width:260px;" v-model="value1" placeholder="搜索单位编码、单位全称、单位简称..."/>
...
<script>
  import {addUnit, queryUnitType, queryUnitData, GetAreaList, deleteUnitInfo} from '@/api/unitList';
          ...
          if(res.IsSuccessful == true) {
            ...
            for(let i = 0; i < row.length; i++) {
              for(let j = 0; j < row[i].OrganTypeList.length; j++) {
                ...
                //备份首选项
                if(i == 0 && j == 0){
                  this.partBackUp = tempObj.label = row[i].OrganTypeList[j].OrganTypeName;
